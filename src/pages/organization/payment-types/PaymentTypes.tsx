          ...
          <TableBody>
            {paginated.map(item => (
              <TableRow key={item.id}>
                <TableCell className="px-6 py-4 max-w-[180px] break-words whitespace-normal">
                  {item.name || '—'}
                </TableCell>
                <TableCell className="px-6 py-4 max-w-[180px] break-words whitespace-normal">
                  {item.description || '—'}
                ...
                <TableCell className="px-6 py-4">
                  {renderBool(item.isSystemDefined)}
                </TableCell>
                <TableCell className="px-6 py-4">
                  {renderBool(item.isCashPayment)}
                </TableCell>
                <TableCell className="px-6 py-4">
                  {item.position ?? '—'}
                </TableCell>
                <TableCell className="px-6 py-4">
                  <div className="flex items-center gap-4">
                    ...
                    <Button
                      ...
                      size="sm"
                      onClick={() =>
                        navigate(`/organization/payment-types/${item.id}/edit`)
                      }
                    >
